...
dtmfmode_op_2: 'RFC2833 in the RTP (if RTP stream is working, otherwise it will send also SIP INFO)',
dtmfmode_op_3: 'Both INFO and RFC2833',
dtmfmode_op_4: 'RFC2833 (will not send SIP INFO even if there is no RTP stream negotiated)',
...
sett_display_name_incomingcallalert_hu: 'Csengetési lejátszó',
sett_comment_incomingcallalert_hu: 'Válaszd ki a csengetési lejátszót. Csak speciális eszközöknél kell megváltoztatni, vagy különleges követelmények esetén, vagy haaz automatikus beállítás nem preferált',
sett_comment_short_incomingcallalert_hu: '',
...
dtmfmode_op_0_hu: 'Tiltva',
dtmfmode_op_1_hu: 'Sip INFO metodus',
dtmfmode_op_2_hu: 'RFC2833 az RTPben (ha az RTP mukodik maskeppen ugyancsak SIP INFO-t fog kuldeni)',
dtmfmode_op_3_hu: 'Mindketto INFO es RFC2833',
dtmfmode_op_4_hu: 'RFC2833 (nem fog SIP INFO-t kuldeni, akkor sem ha nincs RTP egyeztetes)',
...
dtmfmode_op_0_pt: 'Desativado',
dtmfmode_op_1_pt: 'Método SIP INFO',
dtmfmode_op_2_pt: 'RFC2833 na RTP (se fluxo RTP está funcionando, caso contrário ele irá também enviar SIP INFO)',
dtmfmode_op_3_pt: 'Ambos INFO e RFC2833',
dtmfmode_op_4_pt: 'RFC2833 (não enviará SIP INFO, mesmo se não houver fluxo RTP negociado)',
...
dtmfmode_op_0_de: 'Deaktiviert',
dtmfmode_op_1_de: 'Sip INFO Methode',
dtmfmode_op_2_de: 'RFC2833 im RTP (wenn es ein RTP Datenstrom ist, sonst wird\'s SIP-INFO) senden.',
dtmfmode_op_3_de: 'beides INFO und RFC2833',
dtmfmode_op_4_de: 'RFC2833 (Wird kein SIP-INFO gesendet, auch wenn kein RTP Datenstrom ausgehandelt wurde.)',
...
sett_display_name_incomingcallalert_de: 'Ringer player',
sett_comment_incomingcallalert_de: 'Select audio player stream for ring. Should be changed only on special devices or if you have special requirements or the automatic setting is not the preferred',
sett_comment_short_incomingcallalert_de: '',
...
//    if (available_lan.indexOf(lan) < 0)
//    {
//        try{ if (console && console.log) { console.log('ERROR, language not supported: ' + lan); } }catch (e){}
//    }
